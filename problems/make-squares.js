...
and two index pointers -- one that starts at each end of input array (0, n - 1). While the left pointer is less 
than or equal to the right (or the counter index is greater than 0), check the square of numbers at each pointer index.
